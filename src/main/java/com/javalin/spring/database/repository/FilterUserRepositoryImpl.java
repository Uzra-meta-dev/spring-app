...
import com.javalin.spring.database.entity.QUser;
import com.javalin.spring.database.entity.Role;
import com.javalin.spring.database.entity.User;
import com.javalin.spring.database.querydsl.QPredicates;
...
import static com.javalin.spring.database.entity.QUser.*;
...
//                .toArray(Map[]::new);
        ...
        namedParameterJdbcTemplate.batchUpdate(UPDATE_COMPANY_AND_ROLE_NAMED, parameters);
    }
}
